defmodule HelloWeb.ChatHomeLive do
  ...
  def mount(_params,  _session, socket) do
    ...
    {:ok, _} = Hello.Presence.track(self(), "room_presence:"<>room, socket.assigns.current_user.id, %{
  ...
  def handle_event("message", %{"message"=>msg}, socket) do
    ...
    msg_=Repo.insert(
      %Message{text: msg, user_id: socket.assigns.current_user.id, room_id: socket.assigns.room_struct.id}
    )
